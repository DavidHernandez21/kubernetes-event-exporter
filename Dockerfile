...
COPY . /app
WORKDIR /app
RUN CGO_ENABLED=0 GOOS=linux GO11MODULE=on go build -pgo=/app/pgo/kind_18_01_26_19_34.pprof.samples.cpu.pb.gz.gz -ldflags="-s -w -X ${PKG}/version.Version=${VERSION}" -a -o /main .
